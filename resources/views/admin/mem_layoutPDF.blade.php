...
<div class="container" style="margin-top: 5%; font-size: 13px;">
    ...
    <p style="text-align:left;">Name of Contributor:

        <u>{{ $users->firstname }} {{ $users->lastname }}</u>
    ...
    <p>Address:
        ...
        <u>{{ $users->user_street }}, {{ $users->user_barangay }}, 
        {{ $users->user_city }}, {{ $users->user_zip }}</u>
