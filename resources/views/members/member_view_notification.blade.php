                    ...
                    <div class="col-lg-12">
                        <div class="card"  id="reload">
                            ...
                            <div class="col">
                              ...
                              <p class="text-start mx-4">{{ $tithe_view->firstname }} {{ $tithe_view->lastname }} 
                                ...
                                @elseif($tithe_view -> type == 'Disbursement')
                                    @if( $tithe_view->notif_type == "Added")
                                                ...
                                                <div class="media-body">
                                                    <div class="row my-2">
                                                        <div class="col-md-2">
                                                            <p class="mb-1   text-xs text-color-gray-lighter gotham-book"> Name of Contributor </p>
                                                                <h6 class="text-gray  text-sm">
                                                                    <span><h6 class="text-sm"><a href="/member_tithes/{{ $tithe_info->member_ID }}" data-bs-toggle="tooltip" title="View Profile"> {{ $tithe_info->firstname }} {{ $tithe_info->lastname }} </a></h6></span>
                                                                </h6>
                                                        </div>
                                                        ...
                                                        <div class="col"><p class="mb-1  text-xs text-color-gray-lighter gotham-book"> Type </p>
                                                            ...
                                                            @elseif ($tithe_info->tithes_offer_type == 'GCash')
                                                                <span  class="badge badge-sm bg-gradient-success">
                                                                    GCash
                                                                </span></h6>

                                                            @elseif ($tithe_info->tithes_offer_type == 'Bank')
