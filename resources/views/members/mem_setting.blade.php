                ...
                <div class="card mb-4">
                    <div class="card-body" id="profile_picture_settings">
                        <div class="card-header text-center">
                            ...
                            <div class="row">
                                <div class="col-md-12" id="profile_picture_settings">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form>
                                ...
                                <div class="col" id="profile_information_settings">
                                    <table class="table">
                                    ...
                                    <div class="row mt-5">
                                        <button id="save_button_settings" class="btn btn-primary btn-update" data-id="{{ Auth::user()->uID }}">
                                            Save
                                        </button>
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success:function(data) {
                            ...
                            if(data.status) {
                                ...
                                toastr.success("You have successfully modified your details!");
                                ...
                                setTimeout(function(){
                                    ...
                                    $('[id="birthday"]').val('');
                                    $('[id="email"]').val('');
                                    $('[id="user_mobile_number"]').val('');
                                    $('[id="user_street"]').val('');
                                    $('[id="user_barangay"]').val('');
                                    $('[id="user_city"]').val('');
                                    $('[id="user_zip"]').val('');
